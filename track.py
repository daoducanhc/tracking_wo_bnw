...
def main(opt, data_root='/data/MOT16/train', det_root=None, seqs=('MOT16-05',), exp_name='demo_tracktor_and_jde30',
    ...
    for seq in seqs:
        ...
        dataloader = datasets.LoadImages(osp.join(data_root, seq, 'img1'), [1920, 1080])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/model_epoch_27.model', help='path to weights file')
