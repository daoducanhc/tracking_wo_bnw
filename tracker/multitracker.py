...
class JDETracker(object):
    def __init__(self, opt, frame_rate=30):
        ...
        self.model.load_state_dict(torch.load(osp.join("output/mot_17", 'model_epoch_10.model'), map_location=self.device))
    ...
    def update(self, im_blob, img0):
        ...
        if len(detection) > 0:
            ...
            dets = detection[0]['boxes']
            dets = torch.cat((dets, detection[0]['scores'].unsqueeze(1)), dim=1)
